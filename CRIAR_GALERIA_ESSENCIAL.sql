-- =====================================================
-- SCRIPT ESSENCIAL: GALERIA FUNCIONAL
-- =====================================================
...
-- =====================================================
-- 4. CRIAR POLÍTICAS BÁSICAS (SEM CONFLITOS)
-- =====================================================
...
-- =====================================================
-- 
-- As políticas de storage precisam ser criadas manualmente
-- no Supabase Dashboard:
-- 
-- 1. Ir para Authentication > Policies
-- 2. Selecionar "storage.objects"
-- 3. Criar as seguintes políticas:
-- 
-- Política 1: "Anyone can view gallery images"
-- - Operation: SELECT
-- - Target roles: anon, authenticated
-- - USING expression: bucket_id = 'gallery-images'
-- 
-- Política 2: "Admins can upload gallery images"
-- - Operation: INSERT
-- - Target roles: authenticated
-- - WITH CHECK expression: bucket_id = 'gallery-images' AND public.is_admin()
-- 
-- Política 3: "Admins can update gallery images"
-- - Operation: UPDATE
-- - Target roles: authenticated
-- - USING expression: bucket_id = 'gallery-images' AND public.is_admin()
-- 
-- Política 4: "Admins can delete gallery images"
-- - Operation: DELETE
-- - Target roles: authenticated
-- - USING expression: bucket_id = 'gallery-images' AND public.is_admin()
-- 
...
-- ✅ Políticas da tabela criadas (sem conflitos)
-- ✅ Imagem de exemplo inserida (se não existir nenhuma)
-- ⚠️  Políticas de storage precisam ser criadas manualmente
-- 
-- =====================================================
