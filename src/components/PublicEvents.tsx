...
const PublicEvents = () => {
  ...
  return <section id="events" className="py-20 md:py-32 bg-background">
      ...
      {events && events.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event, index) => <div key={event.id} className="bg-card border border-border rounded-lg p-6 hover:border-primary transition-all animate-fade-in" style={{
