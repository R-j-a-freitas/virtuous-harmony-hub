...
const Gallery = () => {
  const images = [
    { src: gallery1, alt: "Performance em casamento elegante" },
    { src: gallery2, alt: "Quarteto de cordas em cerimónia" },
    { src: gallery3, alt: "Música ao vivo em recepção" },
    { src: gallery4, alt: "Ensemble em evento ao ar livre" },
  ];
